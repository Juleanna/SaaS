...
urlpatterns = [
    ...
    path(
        ...
        feature_flags_views.get_user_feature_flags,
        name="user-feature-flags",
    ),
    path(
        "api/feature-flags/store/<int:store_id>/",
        feature_flags_views.get_store_feature_flags,
        name="store-feature-flags",
    ),
    path(
        "api/feature-flags/check/",
        feature_flags_views.check_feature_flag,
        name="check-feature-flag",
    ),
    # Admin Feature Flags API
    path(
        "api/admin/feature-flags/enable/",
        feature_flags_views.admin_enable_flag,
        name="admin-enable-flag",
    ),
    path(
        "api/admin/feature-flags/disable/",
        feature_flags_views.admin_disable_flag,
        name="admin-disable-flag",
    ),
    path(
